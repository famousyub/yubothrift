...
class MyError(TException):
    ...
    def __init__(self, error_code=None, error_description=None,):
        super(MyError, self).__setattr__('error_code', error_code)
        super(MyError, self).__setattr__('error_description', error_description)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.error_code, self.error_description, ))
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    error_description = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
